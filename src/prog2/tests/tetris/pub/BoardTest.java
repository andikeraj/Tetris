...
public class BoardTest implements PublicTest, BoardExercise {
	...
	public void testCanAdd() throws Exception {
		...
		assertFalse("should not be able to add piece at a wrong position", board.canAddPiece(p, 15, 0));
	}

	// @Test

	// public void testcandeletrow() throws Exception {
	// 	assertFalse("brrr", board.canRemovePiece(p, 10, 10));
	// 	assertFalse("should not be able to add piece at a wrong position", board.canRemovePiece(p, 1000, 1000));
	// }
